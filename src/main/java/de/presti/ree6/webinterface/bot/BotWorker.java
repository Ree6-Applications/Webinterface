...
public class BotWorker {
    ...
    public static void createBot(BotVersion version1, String build1) throws LoginException {
        version = version1;
        token = BotWorker.version == BotVersion.DEV ? Server.getInstance().getConfig().getConfiguration().getString("bot.tokens.dev") : Server.getInstance().getConfig().getConfiguration().getString("bot.tokens.rel");
        state = BotState.INIT;
        build = build1;
