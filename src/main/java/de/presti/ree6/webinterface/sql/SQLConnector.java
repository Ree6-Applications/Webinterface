...
import de.presti.ree6.webinterface.sql.migrations.MigrationUtil;
...
public class SQLConnector {
    ...
    public SQLConnector(String databaseUser, String databaseName, String databasePassword, String databaseServerIP, int databaseServerPort) {
        ...
        switch (Server.getInstance().getConfig().getConfiguration().getString("hikari.misc.storage").toLowerCase()) {
        ...
        SQLSession.setMaxPoolSize(Server.getInstance().getConfig().getConfiguration().getInt("hikari.misc.poolSize"));
    ...
    public void createTables() {
        ...
        try (InputStream inputStream = Server.class.getClassLoader().getResourceAsStream("sql/schema.sql")) {
    ...
    public String buildConnectionURL() {
        ...
        switch (databaseTyp) {
            ...
            default -> jdbcUrl = DatabaseTyp.SQLite.getJdbcURL().formatted(Server.getInstance().getConfig().getConfiguration().getString("hikari.misc.storageFile"));
        }
        return jdbcUrl;
    }
    ...
    /**
     * Retrieve the current Database-Typ
     * @return the {@link DatabaseTyp}
     */
