...
import de.presti.ree6.webinterface.sql.entities.*;
...
import de.presti.ree6.webinterface.sql.entities.stats.Statistics;
...
public record SQLWorker(SQLConnector sqlConnector) {
    ...
    public void deleteAllData(String guildId) {
        Reflections reflections = new Reflections("de.presti.ree6.webinterface.sql.entities");
